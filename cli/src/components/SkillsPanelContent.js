...
const MAX_VISIBLE = 8;
export const SkillsPanelContent = ({ controller, onClose, onUseSkill }) => {
    ...
    const handleToggle = useCallback(async () => {
        ...
        const update = (enabled) => setter((prev) => prev.map((s) => (s.path === entry.skill.path ? { ...s, enabled } : s)));
        // Optimistic update
        update(newEnabled);
        try {
    ...
    if (isLoading) {
        return (React.createElement(Panel, { label: "Skills" },
    ...
    return (React.createElement(Panel, { label: "Skills" },
        React.createElement(Box, { flexDirection: "column", gap: 1 },
            skillEntries.length === 0 ? (React.createElement(Box, { flexDirection: "column", gap: 1 },
                React.createElement(Text, { color: "gray" }, "No skills installed."),
                React.createElement(Text, null,
                    "Install skills with: ",
                    React.createElement(Text, { color: "white" }, "npx skills add owner/repo")))) : (React.createElement(Box, { flexDirection: "column" }, skillEntries
                ...
                return (React.createElement(React.Fragment, { key: entry.skill.path },
                    showHeader && (React.createElement(Box, { marginTop: actualIndex > 0 ? 1 : 0 },
                        React.createElement(Text, { bold: true, color: "gray" }, entry.isGlobal ? "Global Skills:" : "Workspace Skills:"))),
                    React.createElement(SkillRow, { isSelected: actualIndex === selectedIndex, skill: entry.skill })));
            }))),
            showMarketplace && (React.createElement(Box, { marginTop: 1 },
                React.createElement(Text, { color: isMarketplaceSelected ? "cyan" : undefined },
                    isMarketplaceSelected ? "❯ " : "  ",
                    React.createElement(Text, { color: COLORS.primaryBlue }, "Browse more skills at https://skills.sh/")))),
            React.createElement(Box, { marginTop: 1 },
                React.createElement(Text, { color: "gray" },
                    "\u2191/\u2193 Navigate \u2022 Enter ",
                    isMarketplaceSelected ? "Open" : "Use",
                    !isMarketplaceSelected && " • Space Toggle")))));
};
const SkillRow = ({ skill, isSelected }) => {
...
//# sourceMappingURL=SkillsPanelContent.js.map