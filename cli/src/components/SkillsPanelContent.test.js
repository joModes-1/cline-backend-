...
describe("SkillsPanelContent", () => {
    ...
    describe("keyboard interactions", () => {
        it("should call onClose when Escape is pressed", async () => {
            ...
            const { stdin } = render(React.createElement(SkillsPanelContent, { ...defaultProps }));
            await delay();
        ...
        it("should call toggleSkill when Space is pressed on a skill", async () => {
            ...
            stdin.write(" "); // Space
            await delay();
            expect(mockToggleSkill).toHaveBeenCalledWith(mockController, expect.objectContaining({
        ...
        it("should revert optimistic toggle on failure", async () => {
            ...
            const { stdin, lastFrame } = render(React.createElement(SkillsPanelContent, { ...defaultProps }));
            await delay();
    ...
    describe("skill loading", () => {
        it("should call refreshSkills on mount", async () => {
            render(React.createElement(SkillsPanelContent, { ...defaultProps }));
            await delay();
            expect(mockRefreshSkills).toHaveBeenCalled();
        });
    });
});
//# sourceMappingURL=SkillsPanelContent.test.js.map