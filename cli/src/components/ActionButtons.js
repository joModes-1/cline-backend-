 ...
 */
export function getButtonConfig(message, isStreaming = false) {
    if (!message) {
 ...
 */
export function getVisibleButtons(config) {
 ...
 */
export const ActionButtons = ({ config, mode = "act" }) => {
    ...
    const renderButton = (text, shortcut) => {
        ...
        return (React.createElement(Text, { backgroundColor: modeColor, color: "black" }, paddedLabel));
    };
    return (React.createElement(Box, { flexDirection: "row", gap: 1, marginLeft: 1, width: "100%" },
