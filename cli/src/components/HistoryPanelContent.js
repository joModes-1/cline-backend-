...
export const HistoryPanelContent = ({ onClose, onSelectTask, controller }) => {
    ...
    const renderContent = () => {
        if (loading) {
            return React.createElement(Text, { color: "gray" }, "Loading history...");
        }
        if (items.length === 0) {
            return React.createElement(Text, { color: "gray" }, searchQuery ? "No tasks match your search." : "No task history.");
        }
        return (React.createElement(Box, { flexDirection: "column" },
            React.createElement(Text, { color: "gray" }, showUpIndicator ? "  ▲" : " "),
            visibleItems.map((item, idx) => {
                ...
                return (React.createElement(Box, { flexDirection: "column", key: item.id },
                    React.createElement(Box, { overflow: "hidden" },
                        React.createElement(Text, { color: isSelected ? COLORS.primaryBlue : undefined, wrap: "truncate" },
                            isSelected ? "❯ " : "  ",
                            taskText)),
            ...
            React.createElement(Text, { color: "gray" }, showDownIndicator ? "  ▼" : " ")));
    };
    return (React.createElement(Panel, { label: "History" },
        React.createElement(Box, null,
            React.createElement(Text, { color: "gray" }, "Search: "),
            React.createElement(Text, { color: "white" }, searchQuery),
            React.createElement(Text, { inverse: true }, " ")),
        React.createElement(Box, null,
            React.createElement(Text, { color: "gray" }, searchQuery ? "Esc to clear" : "Enter to open · Esc to close")),
        renderContent()));
};
//# sourceMappingURL=HistoryPanelContent.js.map