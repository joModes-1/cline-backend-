 ...
 */
export class CliDiffServiceClient {
    ...
    async getDocumentText(_request) {
    ...
    async openMultiFileDiff(request) {
 ...
 */
export class CliEnvServiceClient {
    clipboardContent = "";
    getTelemetrySetting() {
 ...
 */
export class CliWindowServiceClient {
 ...
 */
export class CliWorkspaceServiceClient {
    workspacePath;
 ...
 */
export function createCliHostBridgeProvider(workspacePath) {
    return {
