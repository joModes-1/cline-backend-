 ...
 */
function parseKeyboardSequence(input) {
 ...
 */
export function findWordStart(text, cursorPos) {
    let pos = cursorPos;
 ...
 */
export function findWordEnd(text, cursorPos) {
    let pos = cursorPos;
    // Skip word characters
...
export function useTextInput() {
    ...
    const handleKeyboardSequence = useCallback((input) => {
    ...
    const handleCtrlShortcut = useCallback((key) => {
