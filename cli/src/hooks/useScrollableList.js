 ...
 */
export function useScrollableList(itemCount, selectedIndex, maxRows) {
    return useMemo(() => {
        ...
        if (needsTopIndicator && selectedIndex >= maxRows - 1)
            itemSlots--;
        if (needsBottomIndicator && selectedIndex <= itemCount - maxRows)
            itemSlots--;
...
//# sourceMappingURL=useScrollableList.js.map