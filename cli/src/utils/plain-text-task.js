 ...
 */
export async function runPlainTextTask(options) {
    ...
    subscribeToState(controller, {}, async ({ stateJson }) => {
        try {
 ...
 */
function handleMessageForPipeMode(message, verbose) {
...
//# sourceMappingURL=plain-text-task.js.map