 ...
 */
function getNpmTag(currentVersion) {
 ...
 */
function getInstallationInfo(currentVersion) {
 ...
 */
export function autoUpdateOnStartup(currentVersion) {
    // Skip in dev mode
...
async function checkAndUpdate(currentVersion, updateCommand) {
    try {
