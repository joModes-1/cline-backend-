...
export class DevfileParser {
     ...
     */
    generateFromLanguage(language, name, repoUrl) {
     ...
     */
    detectLanguage(devfile) {
        // Check explicit metadata
        if (devfile.metadata.language) {
            return devfile.metadata.language;
        }
        // Check tags
     ...
     */
    getRunCommand(devfile) {
        const cmd = devfile.commands?.find(c => c.id.toLowerCase().includes('run') ||
     ...
     */
    getBuildCommand(devfile) {
        const cmd = devfile.commands?.find(c => c.id.toLowerCase().includes('build') ||
...
//# sourceMappingURL=DevfileParser.js.map