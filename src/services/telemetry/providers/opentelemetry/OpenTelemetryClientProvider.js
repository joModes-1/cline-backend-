        ...
        for (const exporterType of exporters) {
            try {
                ...
                if (exporter) {
                    ...
                    Logger.log(`[OTEL] Log batch processor configured: maxQueue=${batchConfig.maxQueueSize}, batchSize=${batchConfig.maxExportBatchSize}, timeout=${batchConfig.scheduledDelayMillis}ms`);
                }
            }
            catch (error) {
