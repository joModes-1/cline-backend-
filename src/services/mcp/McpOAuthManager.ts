...
class ClineOAuthClientProvider implements OAuthClientProvider {
	...
	// OAuthClientProvider interface methods
	async getClient(): Promise<OAuthClientInformationFull> {
...
export class McpOAuthManager {
	private providers: Map<string, ClineOAuthClientProvider> = new Map()
	 ...
	 */
	async getOrCreateProvider(serverName: string, serverUrl: string): Promise<ClineOAuthClientProvider> {
