...
export function isGptOssModelFamily(id) {
    const modelId = normalize(id);
...
export function isDevstralModelFamily(id) {
    const modelId = normalize(id);
    return modelId.includes("devstral");
}
export function isTrinityModelFamily(id) {
    const modelId = normalize(id);
...
export function isGeminiFlashModel(id) {
    const modelId = normalize(id);
...
export function isDeepSeekNativeModelFamily(id) {
    const modelId = normalize(id);
 ...
 */
export function isParallelToolCallingEnabled(enableParallelSetting, providerInfo) {
