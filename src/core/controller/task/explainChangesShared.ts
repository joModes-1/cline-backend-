...
export async function setupCommentController(
	...
	commentController.setOnReplyCallback(async (filePath: string, startLine: number, endLine: number, replyText: string, existingComments: string[], onChunk: (chunk: string) => void) => {
