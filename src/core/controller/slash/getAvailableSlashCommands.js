 ...
 */
export async function getAvailableSlashCommands(controller, _request) {
    const commands = [];
    // Add built-in commands
    for (const cmd of [...BASE_SLASH_COMMANDS]) {
        commands.push(SlashCommandInfo.create({
            name: cmd.name,
...
//# sourceMappingURL=getAvailableSlashCommands.js.map