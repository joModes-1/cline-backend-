 ...
 */
async function scanSkillsDirectory(dirPath) {
    const skills = [];
 ...
 */
export async function refreshSkills(controller) {
...
//# sourceMappingURL=refreshSkills.js.map