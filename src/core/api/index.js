...
function createHandlerForProvider(apiProvider, options, mode) {
    switch (apiProvider) {
        ...
        case "cline": {
            const clineModelId = (mode === "plan" ? options.planModeClineModelId : options.actModeClineModelId) ||
        ...
        case "vercel-ai-gateway":
            return new VercelAIGatewayHandler({
                ...
                openRouterModelId: mode === "plan" ? options.planModeVercelAiGatewayModelId : options.actModeVercelAiGatewayModelId,
                openRouterModelInfo: mode === "plan" ? options.planModeVercelAiGatewayModelInfo : options.actModeVercelAiGatewayModelInfo,
                reasoningEffort: mode === "plan" ? options.planModeReasoningEffort : options.actModeReasoningEffort,
                thinkingBudgetTokens: mode === "plan" ? options.planModeThinkingBudgetTokens : options.actModeThinkingBudgetTokens,
            });
        case "zai":
