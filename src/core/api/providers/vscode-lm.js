...
export class VsCodeLmHandler {
    ...
    async getVscodeModule() {
        ...
        try {
            ...
            throw new Error("Cline <Language Model API>: VS Code language model provider requires the VS Code extension host. 'vscode' module not available.");
        }
        try {
