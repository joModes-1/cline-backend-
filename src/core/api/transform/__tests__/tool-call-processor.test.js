...
describe("getOpenAIToolParams", () => {
    it("should include parallel_tool_calls when enabled", () => {
        ...
        const params = getOpenAIToolParams(tools, true);
