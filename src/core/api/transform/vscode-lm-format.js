...
export function convertToVsCodeLmMessages(anthropicMessages, vscodeModule) {
...
export function convertToAnthropicRole(vsCodeLmMessageRole, vscodeModule) {
    const vscode = vscodeModule;
...
export function convertToAnthropicMessage(vsCodeLmMessage, vscodeModule) {
    const vscode = vscodeModule;
    const anthropicRole = convertToAnthropicRole(vsCodeLmMessage.role, vscodeModule);
