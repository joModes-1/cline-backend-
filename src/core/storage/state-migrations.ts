...
export async function cleanupMcpMarketplaceCatalogFromGlobalState(context: ExtensionContext) {
	try {
...
export async function cleanupOldApiKey(context: ExtensionContext) {
	try {
